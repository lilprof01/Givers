import { Bell, Check, Clock, Gift, MessageSquare, User, Calendar, Star, Trash2 } from "lucide-react";
...
const mockNotifications = [
  {
    ...
    description: "Sarah M. requested your vintage guitar. Tap to view details and respond.",
    time: "2 minutes ago",
    isRead: false,
    actionRequired: true,
  },
  {
    ...
    description: "Your request for the camping tent has been approved. You can now arrange pickup.",
    time: "1 hour ago",
    isRead: false,
  },
  {
    ...
    description: "Don't forget to pick up your requested items from Emma's place today.",
    time: "5 hours ago",
    isRead: false,
    actionRequired: true,
  },
  {
    ...
    description: "You've successfully shared 10 items! You're now a 'Generous Giver'.",
    time: "1 day ago",
    isRead: true,
  },
  {
  ...
  },
  {
    ...
    description: "Your vintage camera is now live on Givers! Members can start requesting it.",
    time: "3 days ago",
    isRead: true,
  },
];
...
export const Notifications = () => {
  ...
  const type = mockNotifications.map((t) => t.type);
      ...
      <div className="space-y-3">
        {notifications.length === 0 ? (
          <div className="p-12 text-center bg-white/80 backdrop-blur-sm">
            ...
            <p className="opacity-70">You'll see notifications here when something happens.</p>
          </div>
        ) : (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <h3 className={`font-medium ${!notification.isRead ? '' : 'opacity-80'}`}>
                          {notification.title}
                        </h3>
      ...
      {notifications.some(n => n.actionRequired && !n.isRead) && (
        <div className="p-6 bg-gradient-to-r from-blue-50 to-green-50 border-blue-200 dark:from-blue-900 dark:to-green-900 rounded-lg">
          ...
          <p className="opacity-80 mb-4">
            You have {notifications.filter(n => n.actionRequired && !n.isRead).length} notifications that need your attention.
          </p>
