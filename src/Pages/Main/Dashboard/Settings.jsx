...
import { Bell, Eye, Globe, Lock, Mail, Palette, Shield, User } from "lucide-react";
          ...
          <div className="space-y-6 py-5">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <button variant="outline" className="w-full justify-start flex items-center gap-4 border border-gray-300 dark:border-gray-700 p-2 rounded-lg cursor-pointer hover:bg-gray-400/20 transition-all duration-300">
          ...
          <div className="space-y-6 py-5">
            <div className="flex items-center justify-between">
              ...
              <div className="w-14 h-8 bg-gray-200 rounded-full p-1">
                <div className="h-full w-[50%] rounded-full bg-white"/>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2 flex flex-col gap-2">
                ...
                <select className="border border-gray-300 dark:border-gray-700 rounded-lg p-2 dark:*:bg-black">
                  ...
                  <option>UTC−08:00 (PT) – Pacific Time zone</option>
                  <option>UTC+00:00 (GMT in winter/BST in summer)</option>
                  <option>UTC−06:00 (CT)— Manitoba, Nunavut</option>
                </select>
              </div>
            </div>
          </div>
