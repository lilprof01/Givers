        ...
        <div className=" p-5 rounded-lg">
          ...
          <div className="mt-2 w-full sm:mx-auto sm:w-full sm:max-w-sm px-10">
            ...
            <div className="flex justify-between items-center align-middle my-5">
              <div className="h-[0.5px] w-[30%] bg-black dark:bg-white"/><p className="text-xs text-center w-[40%]">Or continue with</p><div className="h-[0.5px] w-[30%] bg-black dark:bg-white"/>
            </div>
